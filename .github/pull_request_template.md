...
- [ ] `pytest -q` is green (current baseline: **579/579**)
...
- [ ] My commit messages include `Co-authored-by: Copilot <223557919+Copilot@users.noreply.github.com>` when AI assistance was used
