...
pytest -q          # should print "549 passed" (or higher)
python -m rin --smoke
```
...
- **Co-author your commits with Copilot** when you used AI assistance
  ...
  ```
  Co-authored-by: Copilot <223554919+Copilot@users.noreply.github.com>
  ```
...
> The current baseline is **549 passed**; PRs must not regress that count.
